...
public class Workshop14{
    ...
    private static String filePathAndName = "D:/Green_fox_academy/JAVA/JAVA_Projects/Fourth_project/customers.txt";
    ...
    private static class Customer{
        ...
        public Customer(String firstNamekutya, String lastNamekutya, int custAgekutya){
            this.firstName = firstNamekutya;
            this.lastName = lastNamekutya;
            this.custAge = custAgekutya;
        }
